...
model = dict(
    ...
    combine=False,
    language_edit=True,
    language_encoder_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/pretrained/language_encoder_ckpt.pth",
    ldm_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/pretrained/ldm_ckpt.pth",
...
resume_path="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/pn_aware_attn_both_feat_guidance_200T_no_augment/checkpoints/ckpt_8000.pth"
model_only=True
save_num_batch = 1
max_epoch = 8000
eval_interval = 500
