...
model = dict(
    ...
    encoder=dict(
        ...
        part_aligner=dict(
            ...
            cimle=True,
            noise_scale=50,
            cimle_start_epoch=cimle_start_epoch
        ),
        n_class=4,
        kl_weight=0.001,
        fit_loss_type=4,
...
dataset = dict(
    train=dict(
        ...
        batch_size = 128,
        split='trainval',
        root='/mnt/disk3/wang/diffusion/datasets/shapenetcore_partanno_segmentation_benchmark_v0_normal',
        npoints=2048,
...
optimizer = dict(type='Adamax', lr=0.002, weight_decay=0.)
...
resume_path="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/anchordiff_exp423/checkpoints/ckpt_1000.pth"
save_num_batch = 1000
max_epoch = 5000
eval_interval = 500
