...
dataset = dict(
    train=dict(
        ...
        data_dir = "/mnt/disk/wang/diffusion/datasets/partglot_data/shapenet_pointcloud_pn_aware.pkl",
        label_dir = "/mnt/disk/wang/diffusion/datasets/partglot_data/shapenet_label_pn_aware.pkl",
        batch_size=128,
        split='train',
