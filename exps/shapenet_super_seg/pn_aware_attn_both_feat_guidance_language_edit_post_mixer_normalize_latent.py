...
model = dict(
    ...
    language_encoder_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/editing_beta_both_feat_noClassLoss_post_mixer_fuse_latent_normalized_latent/checkpoints/language_encoder.pth",
    update_mlp_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/editing_beta_both_feat_noClassLoss_post_mixer_fuse_latent_normalized_latent/checkpoints/update_mlp.pth",
    diffusion=dict(
