...
model = dict(
    ...
    latent_language_fuser=dict(
        ...
        text_dim=64,
        part_dim=512,
        cat_part_latent=True,
        residual=False,
        cat_referenced_part=True,
        mid_dim=1024,
        conditional=False,
        conditional_dim=24,
        normalize_latent=True
    ),
    language_encoder_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/editing_beta_both_feat_noClassLoss_post_mixer_fuse_latent_normalized_latent_no_res/checkpoints/language_encoder.pth",
    update_mlp_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/editing_beta_both_feat_noClassLoss_post_mixer_fuse_latent_normalized_latent_no_res/checkpoints/update_mlp.pth",
    diffusion=dict(
...
logger = dict(
    type="RunLogger")
resume_path = "/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/pn_aware_attn_both_feat_guidance_200T_1200epoch_normalize_latent/checkpoints/ckpt_1200.pth"
