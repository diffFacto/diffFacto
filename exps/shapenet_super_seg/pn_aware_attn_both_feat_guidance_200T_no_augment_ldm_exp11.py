...
model = dict(
    ...
    combine=False,
    language_edit=True,
    language_encoder_ckpt="/orion/u/w4756677/diffusion/anchorDIff/work_dirs/exp11/checkpoints/language_encoder_ckpt.pth",
    ldm_ckpt="/orion/u/w4756677/diffusion/anchorDIff/work_dirs/exp11/checkpoints/ldm_ckpt.pth",
