...
gen_optimizer = dict(type='Adam', lr=0.0001, weight_decay=0, betas=(0.5, 0.9))
disc_optimizer = dict(type='Adam', lr=0.0001, weight_decay=0., betas=(0.5, 0.9))
gp_weight = 1
gp_type = 'zero_center'
n_class= 4
n_critics= 1
...
resume_path="work_dirs/anchordiff_exp503/checkpoints/ckpt_4000.pth"
save_num_batch = 1
max_epoch = 10000
eval_interval = 500
