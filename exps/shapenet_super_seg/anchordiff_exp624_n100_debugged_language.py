...
dataset = dict(
    train=dict(
        ...
        batch_size = 32,
        split='train',
        data_dir='/orion/u/w4756677/datasets/partglot_data/segmented_triplet.h5',
...
optimizer = dict(type='Adam', lr=0.1, weight_decay=0.)
...
model_only=True
train_aligner=True
resume_path="work_dirs/anchordiff_exp624_n100_debugged/checkpoints/ckpt_1250.pth"