...
model = dict(
    ...
    language_encoder_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/editing_beta_both_feat_no_magloss/checkpoints/language_encoder.pth",
    update_mlp_ckpt="/mnt/disk3/wang/diffusion/anchorDIff/work_dirs/editing_beta_both_feat_no_magloss/checkpoints/update_mlp.pth",
    diffusion=dict(
