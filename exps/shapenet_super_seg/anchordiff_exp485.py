...
model = dict(
    ...
    encoder=dict(
        ...
        gt_param_annealing_start_epoch=0,
        gt_param_annealing_end_epoch=4000,
        kl_weight_annealing=True,
...
optimizer = dict(type='Adamax', lr=0.001, weight_decay=0.)
...
# resume_path="/orion/u/w4756677/diffusion/anchorDIff/work_dirs/anchordiff_exp423/checkpoints/ckpt_1000.pth"
save_num_batch = 1000
max_epoch = 8000
eval_interval = 500
